...
public class AdminController {
    ...
    public void showAllStudents(ActionEvent event){
        dbUtils.close();
        dbUtils.open(); //Problem -> solution. In this method, before adding dbUtils.close/open(), refreshing the tableview with updated
        //info wasn't possible, so i tried this trick to reload the connection between java and MySQL, and now is working properly
